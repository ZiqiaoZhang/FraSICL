...
class MPNLayer(nn.Module):
    def __init__(self, opt):
        ...
        self.opt = opt
        self.hidden_size = self.opt.args['FP_size']
        self.W_bond = nn.Linear(self.hidden_size, self.hidden_size)
        self.dropout_layer = nn.Dropout(p=self.opt.args['drop_rate'])
...
class MPNEncoder(nn.Module):
    def __init__(self, opt, atom_fdim, bond_fdim):
        ...
        self.hidden_size = opt.args['FP_size']
...
class CMPNNModel(nn.Module):
    ...
    def __init__(self, classification: bool, multiclass: bool, opt):
        ...
        self.output_size = opt.args['output_size']
    ...
    def create_ffn(self):
        ...
        dropout = nn.Dropout(self.opt.args['drop_rate'])
