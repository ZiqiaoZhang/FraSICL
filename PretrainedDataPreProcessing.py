...
dataset_file = './Data/PretrainData/pubchem-10m-clean.txt'
...
if not os.path.exists("./Data/PretrainData/pubchem-10m-screened.txt"):
    print("generating 10M dataset....")
    discard_cnt = 0
    screened_cnt = 0
    with open("./Data/PretrainData/pubchem-10m-screened.txt",'w') as f:
...
if not os.path.exists("./Data/PretrainData/pubchem-200K-screened.txt"):
    print(f"generating 200K dataset....")
    discard_cnt = 0
    screened_cnt = 0
    with open("./Data/PretrainData/pubchem-200K-screened.txt", 'w') as f:
        for smiles in dataset:
            mol = GetMol(smiles)
            if mol:
                atom_num = GetAtomNum(mol)
